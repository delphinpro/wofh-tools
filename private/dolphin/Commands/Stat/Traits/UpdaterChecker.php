...
//        $s = Capsule::connection()->getTablePrefix();
//        Capsule::connection()->setTablePrefix('z_'.$sign.'_');
//
        ...
        $queries = [
            'towns' => "
                CREATE TABLE IF NOT EXISTS `z_ruXX_towns` (
                    ...
                    `accountId` MEDIUMINT(6) UNSIGNED NOT NULL,
            ...
            'towns_stat' => "
                ...
                --  `accountId` SMALLINT(6) UNSIGNED NOT NULL,
                    ...
                    `deltaPop` SMALLINT(6) NULL DEFAULT NULL,
                    PRIMARY KEY (`stateAt`, `townId`),
                    INDEX `stateAt` (`stateAt`),
                    INDEX `townId` (`townId`),
                    INDEX `townPop` (`pop`)
                ) COLLATE='utf8_general_ci' ENGINE=InnoDB;",
            ...
            "events" => "
                CREATE TABLE IF NOT EXISTS `z_ruXX_events` (
                    ...
                    `countryIdFrom` INT(11) NULL DEFAULT NULL,
...
//        Capsule::connection()->setTablePrefix($s);
    }
