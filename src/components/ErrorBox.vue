...
.ErrorBox {
  ...
  &_theme_primary { --theme-color: #{$wt-color-primary}; }
  &_theme_info    { --theme-color: #{$wt-color-info}; }
  &_theme_success { --theme-color: #{$wt-color-positive}; }
  &_theme_warning { --theme-color: #{$wt-color-warning}; }
  &_theme_danger  { --theme-color: #{$wt-color-negative}; }
}
</style>
