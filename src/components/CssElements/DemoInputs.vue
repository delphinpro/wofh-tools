...
<template>
  <section class="">
    <div class="row">
      <div class="col-md-6">
        <Box type="info" title="Quick Example">
          <form class="demo">
            <Inputbox
              class="form-group"
              value="Сергей delphinpro Безбородов"
              type="text"
              label="Your name"
      ...
      <div class="col-md-6">
        <Box type="primary" title="General Elements">
          <form class="demo">
            <Inputbox
              class="form-group"
              value="Default value"
        ...
        <Box type="primary" title="Validation status">
          <form class="demo">
            <Inputbox
              class="form-group"
              value="Default value"
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <div class="demo-checkboxes">
                    ...
                    <RadioButton v-model="rb3" :value="2" theme="info" :disabled="true" :checked="true">✓ Disabled
                    </RadioButton>
                  </div>
                </div>
                <div class="form-group">
                  <div class="demo-checkboxes">
                    ...
                    <RadioButton v-model="rb3" :value="2" theme="success" :disabled="true" :checked="true">✓ Disabled
                    </RadioButton>
                  </div>
                </div>
                <div class="form-group">
                  <div class="demo-checkboxes">
                    ...
                    <RadioButton v-model="rb3" :value="2" theme="warning" :disabled="true" :checked="true">✓ Disabled
                    </RadioButton>
                  </div>
                </div>
                <div class="form-group">
                  <div class="demo-checkboxes">
                    ...
                    <RadioButton v-model="rb3" :value="2" theme="danger" :disabled="true" :checked="true">✓ Disabled
                    </RadioButton>
                  </div>
                </div>
              </div>
